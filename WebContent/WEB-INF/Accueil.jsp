                    ...
                    <img src="styl/assets/img/logo.png" />
                        ...
                        <div class="content-wrapper">
                                <div class="container">
                                        ...
                                        <div class="row">
                                                <form class="form-inline" method="post" action="ServAccueil">
                                                        <div class="col-md-12">
                               ...
                               <option value="litterarture fr">literarture fr</option>
                               <option value="histoire">hisoire de l asie</option>
                               <option value="informatique">informatique</option>
                               <option value="mathematique">mathematique</option>
                               <option value="litterature afr">litterature afr</option>
                            </select>


                                                                                <input type="text" class="form-control" name="titre" placeholder="Search term..." />
                                ...
                                <span class="glyphicon glyphicon-search"></span>
                                                ...
                                                <c:choose>
                                                        <c:when test="${nmbre == 0 }">je suis nul</c:when>
                                                        <c:otherwise>
                                                                <c:out value="${rechliv }"></c:out>
                                                        </c:otherwise>
